...
fun main() {
    ...
    // Cetak nama bulan sekarang dan bulan lahir dengan format yang diinginkan
    val birthMonth = "Desember"
    ...
    println("Bulan ini adalah $currentMonthShortForm , sedangkan aku lahir pada bulan $birthMonthShortForm")
}
